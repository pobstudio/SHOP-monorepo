...
contract OpenPiano is ERC721 {
    ...
    function setBaseMetadataURI(string memory _baseMetadataURI, string memory _provenance) public onlyTokenIdZeroOwner {
      baseMetadataURI = _baseMetadataURI;
      provenance = _provenance;
      emit ChangedMetadata(_baseMetadataURI, _provenance);
    }
